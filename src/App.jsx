...
import Audio from "./pages/resources/audio/Audio";
...
import VideoDetail from "./pages/resources/video/VideoDetail";
...
import Quiz from "./pages/resources/quiz/Quiz";
    ...
    return (
      <Router>
        <Routes>
          ...
          <Route path="/resources/video" component={VideoGallery} />
        ...
        <Router>
          ...
          <main className="flex-grow-1 container mt-4">
            <Routes>
              ...
              <Route exact path="/resources/video/:videoId" element={<VideoDetail />} />
              ...
              <Route path="/contributor/details" element={<ContributorDetail setProgress={setProgress} />} />
