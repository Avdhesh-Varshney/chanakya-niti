        ...
        <div className="row">
          <div className="col-md-6 d-flex">
            <figure className="figure">
              ...
              <figcaption className="figure-caption text-center" style={{ color: isDarkMode ? 'white' : 'black' }}>चाणक्य नीति</figcaption>
            </figure>
          ...
          <div className="col-md-3 my-auto">
            <h3 className="text-uppercase fw-bold" style={{ color: isDarkMode ? 'white' : 'black' }}>Resources</h3>
            <ul className="list-unstyled">
              <li><NavLink to="/resources/chanakyagpt" className="text-decoration-none" style={{ color: isDarkMode ? 'white' : 'black' }}><FaRobot className="me-2" /> ChanakyaGpt</NavLink></li>
              <li><NavLink to="/resources/audio" className="text-decoration-none" style={{ color: isDarkMode ? 'white' : 'black' }}><FaMusic className="me-2" /> Audio</NavLink></li>
              <li><NavLink to="/resources/video" className="text-decoration-none" style={{ color: isDarkMode ? 'white' : 'black' }}><FaVideo className="me-2" /> Video</NavLink></li>
              <li><NavLink to="/resources/book" className="text-decoration-none" style={{ color: isDarkMode ? 'white' : 'black' }}><FaBook className="me-2" /> Books</NavLink></li>
              <li><NavLink to="/resources/news" className="text-decoration-none" style={{ color: isDarkMode ? 'white' : 'black' }}><FaNewspaper className="me-2" /> News</NavLink></li>
              <li><NavLink to="/resources/quiz" className="text-decoration-none" style={{ color: isDarkMode ? 'white' : 'black' }}><FaQuestionCircle className="me-2" /> Quiz</NavLink></li>
            </ul>
          </div>
        </div>
      </div>
